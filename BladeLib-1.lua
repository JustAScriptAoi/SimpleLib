...
local RED_DIM = Color3.fromRGB(110, 115, 125)
...
function BladeLib:CreateWindow(config)
	...
	function Window:AddTab(tabConfig)
		...
		function Tab:AddSlider(sliderConfig)
			...
			fillBar.BackgroundColor3 = WHITE
	...
	function Window:AddFloatBtn(floatConfig)
		...
		FloatBtn.Size = UDim2.new(0, 160, 0, 42)
		FloatBtn.Position = UDim2.new(0.5, -80, 0, 15)
		...
		FloatIcon.Size = UDim2.new(0, 20, 0, 20)
		FloatIcon.Position = UDim2.new(0, 10, 0.5, -10)
		FloatIcon.BackgroundTransparency = 1
		FloatIcon.Image = Icons.GetIcon(btnIcon)
		FloatIcon.ImageColor3 = WHITE

		local FloatLabel = Instance.new("TextLabel", FloatBtn)
		FloatLabel.Size = UDim2.new(1, -45, 1, 0)
		FloatLabel.Position = UDim2.new(0, 35, 0, 0)
		FloatLabel.BackgroundTransparency = 1
		FloatLabel.Text = btnName
		FloatLabel.TextColor3 = WHITE
		FloatLabel.Font = Enum.Font.GothamBold
		FloatLabel.TextSize = 13
		...
		UIS.InputChanged:Connect(function(input)
			if draggingFloat and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
				...
				local newPos = UDim2.new(startPosFloat.X.Scale, startPosFloat.X.Offset + delta.X, startPosFloat.Y.Scale, startPosFloat.Y.Offset + delta.Y)
				TweenService:Create(FloatBtn, TweenInfo.new(0.05, Enum.EasingStyle.Linear), {Position = newPos}):Play()
			end
		end)
