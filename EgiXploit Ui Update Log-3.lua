...
function Library:Init(titleName)
    ...
    local MinIconID = "92042704696519"
    local CustomBGID = "92042704696519"
    ...
    local function CreateGradientStroke(parent, thickness)
        ...
        table.insert(StrokeGradients, Grad)
    ...
    function Window:CreateTab(tabName)
        ...
        local TabStroke = CreateGradientStroke(TabBtn, 2)
        ...
        function Elements:AddToggle(text, defaultState, callback)
            ...
            SwitchBg.BackgroundColor3 = toggled and Color3.fromRGB(200, 30, 30) or Color3.fromRGB(40, 55, 48)
            SwitchBg.ZIndex = 4
            ...
            ToggleClick.MouseButton1Click:Connect(function()
                toggled = not toggled
                TweenService:Create(SwitchBg, TweenInfo.new(0.2), {BackgroundColor3 = toggled and Color3.fromRGB(200, 30, 30) or Color3.fromRGB(40, 55, 48)}):Play()
        ...
        function Elements:AddDropdown(text, options, default, callback)
            ...
            for _, optionText in ipairs(options) do
                ...
                local OStroke = CreateGradientStroke(OptionBtn, 2)
        ...
        function Elements:AddMultiDropdown(text, options, callback)
            ...
            for _, optionText in ipairs(options) do
                ...
                local OptionStroke = CreateGradientStroke(OptionBtn, 2)
