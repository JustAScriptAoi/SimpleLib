...
function Library:Init(titleName)
    ...
    function Window:CreateTab(tabName)
        ...
        TabBtn.MouseButton1Click:Connect(function()
            ...
            TabBtn.BackgroundColor3 = Color3.fromRGB(0, 170, 110)
        ...
        function Elements:AddMultiDropdown(text, options, callback)
            ...
            local function UpdateLabel()
                local names = {}
                for optionText, state in pairs(selectedSet) do
                    if state then
                        table.insert(names, tostring(optionText))
                    end
                end
                DLabel.Text = (#names > 0) and (text .. ": " .. table.concat(names, ", ")) or text
            end
            ...
            for _, optionText in ipairs(options) do
                ...
                SwitchBg.BackgroundColor3 = Color3.fromRGB(40, 55, 48)
                SwitchBg.ZIndex = 6
                SwitchBg.Parent = OptionBtn
                ...
                OptionBtn.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(SwitchBg, TweenInfo.new(0.2), {BackgroundColor3 = checked and Color3.fromRGB(0, 180, 110) or Color3.fromRGB(40, 55, 48)}):Play()
                    TweenService:Create(SwitchDot, TweenInfo.new(0.2), {Position = checked and UDim2.new(1, -16, 0.5, -7) or UDim2.new(0, 2, 0.5, -7)}):Play()
                    UpdateLabel()
